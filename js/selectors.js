...
export const upConHeader = document.querySelector(".upcoming");
export const newConHeader = document.querySelector(".new-releases");
export const topRatConHeader = document.querySelector(".top-rated");
